...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Major.catalog_year'
        db.add_column(u'planner_major', 'catalog_year',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='majors', null=True, to=orm['planner.AcademicYear']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Major.catalog_year'
        db.delete_column(u'planner_major', 'catalog_year_id')
