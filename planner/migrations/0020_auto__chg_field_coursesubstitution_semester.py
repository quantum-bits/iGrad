...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CourseSubstitution.semester'
        db.alter_column(u'planner_coursesubstitution', 'semester_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['planner.Semester'], null=True))

    def backwards(self, orm):

        # Changing field 'CourseSubstitution.semester'
        db.alter_column(u'planner_coursesubstitution', 'semester_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['planner.Semester']))
