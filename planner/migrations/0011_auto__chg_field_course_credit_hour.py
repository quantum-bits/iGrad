...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.credit_hour'
        db.alter_column(u'planner_course', 'credit_hour_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['planner.CreditHour']))

    def backwards(self, orm):

        # Changing field 'Course.credit_hour'
        db.alter_column(u'planner_course', 'credit_hour_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['planner.CreditHour']))
    ...
    models = {
        ...
        u'planner.course': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'credit_hour': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'courses'", 'to': u"orm['planner.CreditHour']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
