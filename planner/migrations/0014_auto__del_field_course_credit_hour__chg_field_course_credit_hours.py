...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.credit_hours'
        db.alter_column(u'planner_course', 'credit_hours_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['planner.CreditHour']))

    def backwards(self, orm):
        # Adding field 'Course.credit_hour'
        db.add_column(u'planner_course', 'credit_hour',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='courses', to=orm['planner.CreditHour']),
                      keep_default=False)


        # Changing field 'Course.credit_hours'
        db.alter_column(u'planner_course', 'credit_hours_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['planner.CreditHour'], null=True))
