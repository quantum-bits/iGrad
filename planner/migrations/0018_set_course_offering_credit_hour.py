...
from planner.campus_models import possible_credit_hours
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for course_offering in orm.CourseOffering.objects.all():
            course = course_offering.course
            course_offering.credit_hours = min(possible_credit_hours(course.credit_hours))
            course_offering.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        for course_offering in orm.CourseOffering.objects.all():
            course_offering.credit_hours = 3
            course_offering.save()
