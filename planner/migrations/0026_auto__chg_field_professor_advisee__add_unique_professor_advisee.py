...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Professor.advisee'
        db.alter_column(u'planner_professor', 'advisee_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['planner.Student'], unique=True, null=True))
        # Adding unique constraint on 'Professor', fields ['advisee']
        db.create_unique(u'planner_professor', ['advisee_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Professor', fields ['advisee']
        db.delete_unique(u'planner_professor', ['advisee_id'])


        # Changing field 'Professor.advisee'
        db.alter_column(u'planner_professor', 'advisee_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['planner.Student'], null=True))
