...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Student.university'
        db.alter_column(u'planner_student', 'university_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['planner.University']))

    def backwards(self, orm):

        # Changing field 'Student.university'
        db.alter_column(u'planner_student', 'university_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['planner.University']))
