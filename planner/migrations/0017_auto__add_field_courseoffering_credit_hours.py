...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseOffering.credit_hours'
        db.add_column(u'planner_courseoffering', 'credit_hours',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseOffering.credit_hours'
        db.delete_column(u'planner_courseoffering', 'credit_hours')
