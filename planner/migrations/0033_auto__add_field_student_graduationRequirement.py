...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Student.graduationRequirement'
        db.add_column(u'planner_student', 'graduationRequirement',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['planner.Requirement'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Student.graduationRequirement'
        db.delete_column(u'planner_student', 'graduationRequirement_id')
