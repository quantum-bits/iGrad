...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'planner_course', 'credit_hours')


        # Changing field 'Course.min_credit_hours'
        db.alter_column(u'planner_course', 'min_credit_hours', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Course.max_credit_hours'
        db.alter_column(u'planner_course', 'max_credit_hours', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):
        # Adding field 'Course.credit_hours'
        db.add_column(u'planner_course', 'credit_hours',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=3),
                      keep_default=False)


        # Changing field 'Course.min_credit_hours'
        db.alter_column(u'planner_course', 'min_credit_hours', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Course.max_credit_hours'
        db.alter_column(u'planner_course', 'max_credit_hours', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
