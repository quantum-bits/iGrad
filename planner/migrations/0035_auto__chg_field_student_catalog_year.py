...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Student.catalog_year'
        db.alter_column(u'planner_student', 'catalog_year_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['planner.AcademicYear']))

    def backwards(self, orm):

        # Changing field 'Student.catalog_year'
        db.alter_column(u'planner_student', 'catalog_year_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['planner.AcademicYear']))
    ...
    models = {
        ...
        u'planner.coursesubstitution': {
            ...
            'sub_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'course_substitutions'", 'null': 'True', 'to': u"orm['planner.CourseSubType']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
        ...
        u'planner.coursesubtype': {
            'Meta': {'object_name': 'CourseSubType'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '80'})
        },
