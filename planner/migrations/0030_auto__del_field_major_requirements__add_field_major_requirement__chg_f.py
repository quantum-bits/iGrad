...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Major.requirements'
        db.delete_column(u'planner_major', 'requirements_id')

        # Adding field 'Major.requirement'
        db.add_column(u'planner_major', 'requirement',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='major', unique=True, null=True, to=orm['planner.Requirement']),
                      keep_default=False)


        # Changing field 'Minor.requirement'
        db.alter_column(u'planner_minor', 'requirement_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['planner.Requirement']))
        # Adding unique constraint on 'Minor', fields ['requirement']
        db.create_unique(u'planner_minor', ['requirement_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Minor', fields ['requirement']
        db.delete_unique(u'planner_minor', ['requirement_id'])

        # Adding field 'Major.requirements'
        db.add_column(u'planner_major', 'requirements',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='majors', null=True, to=orm['planner.Requirement']),
                      keep_default=False)

        # Deleting field 'Major.requirement'
        db.delete_column(u'planner_major', 'requirement_id')


        # Changing field 'Minor.requirement'
        db.alter_column(u'planner_minor', 'requirement_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['planner.Requirement']))
