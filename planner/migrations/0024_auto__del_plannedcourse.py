...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'PlannedCourse'
        db.delete_table(u'planner_plannedcourse')

        # Adding M2M table for field planned_courses on 'Student'
        m2m_table_name = db.shorten_name(u'planner_student_planned_courses')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('student', models.ForeignKey(orm[u'planner.student'], null=False)),
            ('courseoffering', models.ForeignKey(orm[u'planner.courseoffering'], null=False))
        ))
        db.create_unique(m2m_table_name, ['student_id', 'courseoffering_id'])


    def backwards(self, orm):
        # Adding model 'PlannedCourse'
        db.create_table(u'planner_plannedcourse', (
            ('offering', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['planner.CourseOffering'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(related_name='planned_courses', to=orm['planner.Student'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'planner', ['PlannedCourse'])

        # Removing M2M table for field planned_courses on 'Student'
        db.delete_table(db.shorten_name(u'planner_student_planned_courses'))
