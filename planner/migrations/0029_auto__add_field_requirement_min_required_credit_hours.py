...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Requirement.min_required_credit_hours'
        db.add_column(u'planner_requirement', 'min_required_credit_hours',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Requirement.min_required_credit_hours'
        db.delete_column(u'planner_requirement', 'min_required_credit_hours')
