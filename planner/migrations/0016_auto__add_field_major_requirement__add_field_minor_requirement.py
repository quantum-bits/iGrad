...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Minor.requirement'
        db.add_column(u'planner_minor', 'requirement',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='minors', null=True, to=orm['planner.Requirement']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Minor.requirement'
        db.delete_column(u'planner_minor', 'requirement_id')
