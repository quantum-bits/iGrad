...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SemesterDateDefault'
        db.create_table(u'planner_semesterdatedefault', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['planner.SemesterName'], unique=True)),
            ('begin_month', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('begin_day', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('end_month', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('end_day', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal(u'planner', ['SemesterDateDefault'])


    def backwards(self, orm):
        # Deleting model 'SemesterDateDefault'
        db.delete_table(u'planner_semesterdatedefault')
