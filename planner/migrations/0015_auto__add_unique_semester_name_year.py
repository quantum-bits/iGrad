...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Semester', fields ['name', 'year']
        db.create_unique(u'planner_semester', ['name_id', 'year_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Semester', fields ['name', 'year']
        db.delete_unique(u'planner_semester', ['name_id', 'year_id'])
