...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseOffering.status'
        db.add_column(u'planner_courseoffering', 'status',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseOffering.status'
        db.delete_column(u'planner_courseoffering', 'status')
