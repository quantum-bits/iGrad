...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.min_credit_hours'
        db.add_column(u'planner_course', 'min_credit_hours',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Course.max_credit_hours'
        db.add_column(u'planner_course', 'max_credit_hours',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.min_credit_hours'
        db.delete_column(u'planner_course', 'min_credit_hours')

        # Deleting field 'Course.max_credit_hours'
        db.delete_column(u'planner_course', 'max_credit_hours')
    ...
    models = {
        ...
        u'planner.course': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'max_credit_hours': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'min_credit_hours': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
