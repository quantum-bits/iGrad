...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SemesterDateDefaults'
        db.create_table(u'planner_semesterdatedefaults', (
        ...
        db.send_create_signal(u'planner', ['SemesterDateDefaults'])


    def backwards(self, orm):
        # Deleting model 'SemesterDateDefaults'
        db.delete_table(u'planner_semesterdatedefaults')
    ...
    models = {
        ...
        u'planner.semesterdatedefaults': {
            'Meta': {'object_name': 'SemesterDateDefaults'},
