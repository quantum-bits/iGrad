...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'CourseSubType'
        db.delete_table(u'planner_coursesubtype')

        # Deleting field 'CourseSubstitution.sub_type'
        db.delete_column(u'planner_coursesubstitution', 'sub_type_id')


    def backwards(self, orm):
        # Adding model 'CourseSubType'
        db.create_table(u'planner_coursesubtype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80, unique=True)),
        ))
        db.send_create_signal(u'planner', ['CourseSubType'])

        # Adding field 'CourseSubstitution.sub_type'
        db.add_column(u'planner_coursesubstitution', 'sub_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='course_substitutions', null=True, to=orm['planner.CourseSubType'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'planner.major': {
            ...
            'catalog_year': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'majors'", 'null': 'True', 'to': u"orm['planner.AcademicYear']"}),
            'department': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'majors'", 'to': u"orm['planner.Department']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'requirement': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'major'", 'unique': 'True', 'null': 'True', 'to': u"orm['planner.Requirement']"})
        },
        u'planner.minor': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'requirement': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'minor'", 'unique': 'True', 'null': 'True', 'to': u"orm['planner.Requirement']"})
        },
        ...
        u'planner.professor': {
            ...
            'advisee': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['planner.Student']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'person_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['planner.Person']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        u'planner.requirement': {
            ...
            'constraints': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'requirements'", 'blank': 'True', 'to': u"orm['planner.Constraint']"}),
            'courses': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'requirements'", 'blank': 'True', 'to': u"orm['planner.Course']"}),
            'display_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'min_required_credit_hours': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        u'planner.student': {
            ...
            'catalog_year': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['planner.AcademicYear']"}),
            'entering_year': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['planner.AcademicYear']"}),
            'graduationRequirement': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['planner.Requirement']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            ...
            'university': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'students'", 'null': 'True', 'to': u"orm['planner.University']"}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True', 'null': 'True'})
        },
        u'planner.subject': {
