...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'planner_course', 'credit_hours',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['planner.CreditHour'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.credit_hours'
        db.delete_column(u'planner_course', 'credit_hours_id')
    ...
    models = {
        ...
        u'planner.course': {
            ...
            'credit_hours': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['planner.CreditHour']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
