...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CourseSubstitution'
        db.create_table(u'planner_coursesubstitution', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('university', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='course_substitutions', null=True, to=orm['planner.University'])),
            ...
            ('equivalent_course', self.gf('django.db.models.fields.related.ForeignKey')(related_name='course_substitutions', to=orm['planner.Course'])),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(related_name='course_substitutions', to=orm['planner.Student'])),
        ))
        db.send_create_signal(u'planner', ['CourseSubstitution'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CourseSubstitution'
        db.delete_table(u'planner_coursesubstitution')
