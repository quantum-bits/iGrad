...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Constraint.comment'
        db.add_column(u'planner_constraint', 'comment',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Constraint.comment'
        db.delete_column(u'planner_constraint', 'comment')
